...
if __name__ == "__main__":
    ...
    base_dir = os.path.dirname(os.path.abspath(__file__))  # cartella contenente test.py
    image_glob = os.path.join(base_dir, "../../esim_py/tests/data/images/images/*.png")
    ...
    timestamps_path = os.path.join(base_dir, "../../esim_py/tests/data/images/timestamps.txt")
    timestamps_s = np.genfromtxt(timestamps_path)
    
    print("Timestamp file path:", timestamps_path)
